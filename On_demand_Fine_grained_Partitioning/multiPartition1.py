...
from On_demand_Fine_grained_Partitioning.PSO1 import PSO
...
def put_all_device_cloud():
    ...
    ideal_device = ConstructEnvironment.Device(0,0,199.2)
    ideal_time = no_partition(ideal_device)
    print("理想状态执行:" + str(ideal_time))
...
def multi_hori_partition(flag, picture_pos):
    ...
    print("nodes",sort_nodes.__len__())
