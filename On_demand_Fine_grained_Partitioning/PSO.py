...
from On_demand_Fine_grained_Partitioning.Util import get_fitness,nodes
...
class PSO:
    def __init__(
        ...
        for i in range(nodes.__len__()):
            print(i,"height_out",nodes[i].height_out)
        print("ss",self.nodes.__len__())
